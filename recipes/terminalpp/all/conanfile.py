...
class TerminaltppConan(ConanFile):
    name = "terminalpp"
    homepage = "https://github.com/KazDragon/terminal"
    description = "A C++ library for interacting with ANSI terminal windows"
    topics = ("terminal-emulators", "ansi-escape-codes", "VT100")
    ...
    def source(self):
        ...
        os.rename("terminalpp-{}".format(self.version), self._source_subfolder)
